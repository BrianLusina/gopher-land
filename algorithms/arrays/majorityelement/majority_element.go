...
// majorityElementWithSorting finds the element that occurs more than n/2 times, where n is the size of the input list.
//
...
func majorityElementWithSorting(nums []int) int {
	sort.IntSlice(nums).Sort()
	n := len(nums)
	return nums[n/2]
}

// majorityElementWithMap finds the element that occurs more than n/2 times, where n is the size of the input list.
//
...
// majorityElementWithVoting finds the element that occurs more than n/2 times, where n is the size of the input list.
//
...
func majorityElementWithVoting(nums []int) int {
