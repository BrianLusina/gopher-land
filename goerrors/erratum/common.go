...
// These are the support types and interface definitions used in the error_handling.go
// implementation of Use function. See the test suite file at
...
func NewUnexpectedError(content interface{}) error {
	return &UnexpectedError{Content: content}
}
